...
<!-- Свернутый блок с примерами использования / скриншотами -->
<details>
  <summary><strong>Скриншоты и примеры использования</strong></summary>
...
<!-- Пример вставки изображений. Замените пути на свои. -->

```markdown
![Основной экран](images/screenshot-main.png)
![Пример команды](images/screenshot-cli.png)
```
...
cd README-Template
```
3. Настройте конфигурацию в .env файле (см. #переменные-окружения-и-конфигурации)
---
